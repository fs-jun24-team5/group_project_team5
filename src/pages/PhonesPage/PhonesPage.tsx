              ...
              <div className={styles.orderBlock}>
                ...
                <div className={styles.chooseColor}>
                  <div
                    ...
                    className={
                      selectedColor === 'color1' ? styles.colorPick_active : styles.colorPick
                    }
                  ></div>
                  <div
            ...
            <div className={styles.container_text}>
              <div className={styles.about}>
                ...
                <p className={styles.smallText}>
                  ...
                  complexity. <br />
                  <br />
                  An unprecedented leap in battery life. And a mind‑blowing chip that doubles down
                  on machine learning and pushes the boundaries of what a smartphone can do. Welcome
                ...
                <p className={styles.smallText}>
                  ...
                  — then edit with the same tools you love for photos. You’ve never shot with
                  anything like it.
                </p>
                ...
                <p className={styles.smallText}>
                  ...
                  fps. You get more creative control, too, with four times more scene and powerful
